...
def init():
    ...
    if z > 70:
        ...
        z = 70
    mc.setBlocks(x-15, -1, z-2, x+15, 50, z+58, block.DIAMOND_ORE.id)
    mc.setBlocks(x-15, -1, z-2, x+15, -1, z+58, block.DOOR_WOOD.id)
    mc.setBlocks(x-2, -1, z-2, x+2, -1, z+58, block.CACTUS.id)
